...
class NotificationService {
  ...
  androidDetails() {
    return const AndroidNotificationDetails(
        'task_manager', 'Task Manager Notifications',
        channelDescription: 'Get reminders for your tasks and stay organized with notifications from the Task Manager App',
  ...
  darwinDetails() {
    return const DarwinNotificationDetails(
        subtitle:
            'Get reminders for your tasks and stay organized with notifications from the Task Manager App',
        presentAlert: true,
        presentBadge: true,
        presentSound: true,
